...
public class Controller extends HttpServlet {
	...
	protected void contatos(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// criando um objeto que irá recever os dados JavaBeans
		ArrayList<JavaBeans> lista = dao.listarContatos();
		// encaminhar a lista ao jsp
	...
	protected void novoContato(HttpServletRequest request, HttpServletResponse response)
		...
		// invocar o método inserirContato passando o objeto do contato
	...
	protected void listarContato(HttpServletRequest request, HttpServletResponse response)
		...
		// Stear os atributos do formulário com o conteúdo Javabeans
	...
	protected void atualizarContato(HttpServletRequest request, HttpServletResponse response)
		...
		// Usando o objeto para fazer uma requisição e armazenar os dados
		contato.setIdcon(request.getParameter("idcon"));
		contato.setNome(request.getParameter("nome"));
		contato.setFone(request.getParameter("fone"));
		contato.setEmail(request.getParameter("email"));

		// Executar o método atualizarContato()
		dao.atualizarContato(contato);
		// redirecionar para o doc agenda.jsp (atualizando as atualizações)
		response.sendRedirect("main");
